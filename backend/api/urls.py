...
urlpatterns = [
    ...
    path('registration/', views.register, name='index'),
	path('verify_code/', views.verify_user_verification_number, name='index'),
	...
	path("dummy-jwt/", views.createDummyJwt, name="dummy-jwt"),
